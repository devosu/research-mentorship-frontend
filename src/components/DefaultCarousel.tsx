  ...
  return (
    ...
    <div
        ...
        <div
            ...
            <h5 className="text-xl">Discover where you <em>thrive</em>.</h5>
            <a
                type="button"
                href='/mentors'
        ...
        <div
        className="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-twe-carousel-item style={{backfaceVisibility: "hidden"}}>
        <img
