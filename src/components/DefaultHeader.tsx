          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  OSU Undergraduate Research Mentorship Program
                </Link>
              </li>
            </ul>
            ...
            <div className="flex items-center">
              ...
              {/* Mentors Link */}
              {(isMentor || (isMentee && isApprovedMentee)) && (
                <Link
                  type="button"
                  href="/mentors"
                  data-twe-ripple-init
                  ...
                  >
                    ...
                    <span className="[&>svg]:w-5">
                      <svg
                        ...
                        fill="currentColor"
                      >
                        <title>Drop Down Menu Button</title>
                        <path
                          fillRule="evenodd"
