  ...
  return (
    <main>
      ...
      >
        ...
        <span
          style={{ margin: "0px 0px 20px 20px", fontSize: "20px" }}
      ...
      {status === "Incomplete" && (
        ...
        >
          <p style={{ marginBottom: "10px", textAlign: "center" }}>
            You have not submitted your application yet. Please click the button
      ...
      {status === "Approved" && (
        ...
        >
          <p style={{ marginBottom: "10px", textAlign: "center" }}>
            Congratulations, your application has been approved! Please click
            the button below to view a list of available mentors.
          </p>
          <button
            type="button"
      ...
      {status === "Submitted" && (
        ...
        >
          <p style={{ marginBottom: "10px", textAlign: "center" }}>
            Your application has been submitted. You will be notified when your
